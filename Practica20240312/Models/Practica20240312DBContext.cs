...
{
    public partial class Practica20240312DBContext : DbContext
    {
        public Practica20240312DBContext()
        {
        }

        public Practica20240312DBContext(DbContextOptions<Practica20240312DBContext> options)
            : base(options)
        {
        }
...
//                optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=Practica20240312DB;Integrated Security=True;Encrypt=False");
//            }
        }
